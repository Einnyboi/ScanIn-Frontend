        ...
        <div className="sticky top-0 z-20 border-b border-slate-200/80 bg-white/95 px-5 py-3 backdrop-blur sm:px-7">
          <div className="flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
            ...
            <div className="flex flex-wrap items-center gap-2 sm:gap-3">
              ...
              <button type="button" onClick={() => setActiveView('notifications')} className="relative flex h-11 items-center justify-center rounded-[8px] border border-slate-200 bg-white px-3 text-sm font-black text-slate-600 transition hover:border-[#5c3386]/40 hover:text-[#5c3386]">
                Notifikasi
                {adminNotificationCount ? <span className="absolute -right-2 -top-2 flex h-6 min-w-6 items-center justify-center rounded-full bg-[#7d2228] px-1.5 text-[11px] font-black text-white">{adminNotificationCount}</span> : null}
              </button>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 py-6 pb-20 sm:px-7 lg:px-8 xl:px-10">
          ...
          <header className="flex flex-col gap-4 lg:flex-row lg:items-end lg:justify-between">
            <div>
              ...
              <p className="mt-2 text-base font-semibold text-slate-500">{meta.subtitle}</p>
            </div>
          </header>
